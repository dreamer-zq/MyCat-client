...
<body>
<div class="area2 notice">会员信息</div>
<div class="area1">
    <table>
        <tr>
        ...
        <tr>
            ...
            <td align="left">${lender.ucode}</td>
        </tr>
        <tr>
            <td align="right">手机号：</td>
            <td align="left">${lender.mobile}</td>
        </tr>
        <tr>
            <td align="right">固定电话：</td>
            <td align="left">${lender.phone}</td>
        </tr>
        <tr>
            <td align="right">邮箱：</td>
            <td align="left">${lender.email}</td>
        </tr>
        <tr>
            <td align="right">国籍：</td>
            <td align="left">${lender.nationality}</td>
        </tr>
        <tr>
            <td align="right">绑定时间：</td>
            <td align="left">${lender.bindTime}</td>
        </tr>
    </table>
</div>
